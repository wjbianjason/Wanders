    ...
    <div class="wrapper choose-account-wrapper">
        <div class="dynamic-row">
            ...
            <div class="box service-pro-account">
                ...
                <a class="btn btn-lg btn-primary btn-block" href="<?php echo Yii::app()->createUrl('register/default/wiker'); ?>">
                    注册
                </a>
            </div>
            ...
            <div class="box standard-account">
                ...
                <a class="btn btn-lg btn-primary btn-block" href="<?php echo Yii::app()->createUrl('register/default/hirer'); ?>">
                    注册
                </a>
            </div>
...
<div class="wrapper">
    <div class="bottom-link-wrapper">
        您已注册
        <a href="<?php echo Yii::app()->createUrl('login'); ?>">
            登录
        </a>
    </div>
</div>